...
def iterate(iterations,radius,particles,M):     #Determine the final mass and radius with iterative scheme
...
def write_files(timevalue,num,radius,M,cms,particles):      #Stores the data in the output file
...
def main():
    ...
    write_files(timevalue,num,radius,M,cms,particles)
